...
struct t2fs_superbloco {
    ...
    WORD    version;        /* Versão atual desse sistema de arquivos: (valor fixo 0x7E0=2016; 1=1º semestre). */
    WORD    superBlockSize; /* Quantidade de blocos lógicos que formam o superbloco. (1 bloco lógico). */
    WORD    blockSize;      /* Quantidade de setores lógicos que formam um bloco lógico */
    DWORD   diskSize;       /* Quantidade de bytes da partição T2FS. Inclui o superbloco, a área de bitmap, o diretório raiz e a área de dados. */
    DWORD   nOfSectors;     /* Quantidade total de setores lógicos na partição T2FS. Inclui o superbloco, a área de bitmap, o diretório raiz e a área de dados. */
    DWORD   bitmapSize;     /* Quantidade de blocos lógicos usados para armazenar o bitmap de blocos livres e ocupados. */
    DWORD   rootSize;       /* Quantidade de blocos lógicos usados para armazenar o diretório raiz. */
    DWORD   nOfDirEntries;  /* Quantidade de entradas no diretório raiz. */
    DWORD   fileEntrySize;  /* Quantidade de bytes de um registro na área de diretório. */
};
...
struct t2fs_record {
    ...
    DWORD   dataPtr[2];	    /* Dois ponteiros diretos (little endian). */
    DWORD   singleIndPtr;   /* Ponteiro de indireção simples (little endian). */
    DWORD   doubleIndPtr;   /* Ponteiro de indireção dupla (little endian). */
};
